...
export function CoursePacingPlanner({ course, scheduleMeetingsPerWeek, saving, onSave }: Props) {
  ...
  const usedPeriods = timeline
    .flatMap((unit) => unit.lessons)
    .reduce((total, lesson) => total + lesson.periods, 0);
    ...
    <section className="card stack pacing-planner">
      <div className="row spread">
        <div>
          ...
          <p className="muted">
            {availablePeriods
              ? `${availablePeriods} class periods planned.`
              : 'Add your teaching weeks or available class periods.'}
          </p>
        </div>
      ...
      <EditFocusDialog
        open={open}
        title="Edit year timeline"
        description="Adjust year assumptions and review their lesson timeline before saving."
                  ...
                  setDraft((current) => {
                    ...
                    return {
                      ...
                      weeks:
                        periods === null
                          ? current.weeks
                          : String(Math.ceil(periods / scheduleMeetingsPerWeek))
                    };
                  })
                }
              >
          ...
          <div className="two-column">
            <label>
                ...
                onChange={(event) => {
                  ...
                  setDraft((current) => {
                    ...
                    return {
                      ...
                      weeks:
                        periods && nextMeetings
                          ? String(Math.ceil(periods / nextMeetings))
                          : current.weeks
                    };
                  });
                }}
              ...
              <span className="field-note">
                Changing this estimate updates the teaching weeks above.
              </span>
            </label>
            <label>
